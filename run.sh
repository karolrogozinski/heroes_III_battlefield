...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
    ...
    . ~/.profile
    g++ -O3 -Wall -shared -std=c++17 -fPIC $(python3 -m pybind11 --includes) src/include/binding.cpp src/include/battle.cpp src/include/hero.cpp src/include/stack.cpp src/include/controller.cpp -o src/bindings$(python3-config --extension-suffix)
    python3 ./src/run.py
